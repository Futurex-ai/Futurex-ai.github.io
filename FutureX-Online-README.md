...
* **This week's tasks cover events with an end time between `2026-03-18, 24:00 (UTC+8)` and `2026-03-24, 24:00 (UTC+8)`.**
...
* The leaderboard for this round will be updated by **`2026-03-26 24:00 (UTC+8, Beijing Time)`**.


**⚠️ Next submission deadline: <span style="color:red">2026-03-18, 24:00 (UTC+8, Beijing Time)</span>**
